...
fp = open('/home/lishuai/work/lfm/test6/pmatrix', 'w')
fq = open('/home/lishuai/work/lfm/test6/qmatrix', 'w')
...
# Pickle the data set 
ftr = open('/home/lishuai/work/lfm/test6/trainset', 'w')
fte = open('/home/lishuai/work/lfm/test6/testset', 'w')
